...
namespace ShopCsharp.Database
{
    ...
    public class MySQLManager<TEntity> : DbContext where TEntity : class
    {
        ...
        public MySQLManager(DataConnectionResource dataConnectionResource) : base("Server=myServer;Port=3306; Database = db_name;Uid = userName;Pwd = password")
        {
          //  FullDB skin = new FullDB(dataConnectionResource);
        }
